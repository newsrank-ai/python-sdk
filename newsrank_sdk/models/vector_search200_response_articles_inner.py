...
class VectorSearch200ResponseArticlesInner(BaseModel):
    """
    VectorSearch200ResponseArticlesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["similarity", "distance", "url_hash", "title", "url", "source_name", "category", "published_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VectorSearch200ResponseArticlesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VectorSearch200ResponseArticlesInner from a dict"""
        if obj is None:
            return None
