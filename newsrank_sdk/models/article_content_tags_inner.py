...
class ArticleContentTagsInner(BaseModel):
    """
    ArticleContentTagsInner
    """ # noqa: E501
    tag: Optional[StrictStr] = None
    score: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["tag", "score"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArticleContentTagsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArticleContentTagsInner from a dict"""
        if obj is None:
            return None
