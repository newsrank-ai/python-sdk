...
class ListEntityArticles200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["items", "total", "offset", "limit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListEntityArticles200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListEntityArticles200Response from a dict"""
        if obj is None:
            return None
