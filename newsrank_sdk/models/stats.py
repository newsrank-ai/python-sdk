...
class Stats(BaseModel):
    ...
    Stats
    """ # noqa: E501
    total_articles: Optional[StrictInt] = None
    total_stories: Optional[StrictInt] = None
    total_entities: Optional[StrictInt] = None
    total_sources: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total_articles", "total_stories", "total_entities", "total_sources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_articles": obj.get("total_articles"),
            "total_stories": obj.get("total_stories"),
