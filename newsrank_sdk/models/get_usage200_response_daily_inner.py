...
class GetUsage200ResponseDailyInner(BaseModel):
    """
    GetUsage200ResponseDailyInner
    """ # noqa: E501
    day_ms: Optional[StrictInt] = None
    requests: Optional[StrictInt] = None
    errors: Optional[StrictInt] = None
    bytes: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["day_ms", "requests", "errors", "bytes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetUsage200ResponseDailyInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetUsage200ResponseDailyInner from a dict"""
        if obj is None:
            return None
